...
class CCTray
  ...
  def fetch
    builds = Nokogiri::XML(get).css("Project").select { |project| ['coupa_development (011_release)' ,'coupa_development (012_release)', 'coupa_development (master)', 'coupa_development (012_release_unit_tests)', 'coupa_development (012_0_8_release)', 'coupa_development (011_0_21_release)'].any? { |w| project['name'] == w } }
