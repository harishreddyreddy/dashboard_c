...
class CCTray
  ...
  def fetch
    builds = Nokogiri::XML(get).css("Project").select { |project| ['011_release_fox' ,'012_release_fox', 'master_fox', '012_release_unit_tests', '012_0_4_release', '011_0_17_release'].any? { |w| project['name'] =~ /#{w}/ } }
