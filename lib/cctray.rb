...
class CCTray
  ...
  def fetch
    builds = Nokogiri::XML(get).css("Project").select { |project| ['coupa_development (011_release)' , 'coupa_development (013_release)', 'coupa_development (013_0_1_release)', 'coupa_development (012_release)', 'coupa_development (master)', 'coupa_development (012_0_13_release)', 'coupa_development (011_0_22_release)'].any? { |w| project['name'] == w } }
